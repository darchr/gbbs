...
template <class Wgh>
static inline symmetric_ptr_graph<symmetric_vertex, Wgh>
sym_ptr_graph_from_edges(pbbs::sequence<std::tuple<uintE, uintE, Wgh>> &A,
    ...
    auto GP = symmetric_ptr_graph<symmetric_vertex, Wgh>(G.n, G.m, vertices,
                                                         G.deletion_fn);
    return GP;
}
