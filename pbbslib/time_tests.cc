...
bool run_multiple(size_t n, size_t rounds, float bytes_per_elt,
    ...
    std::cout << name << std::setprecision(3) << ": r=" << rounds
              << ", med=" << med << " (" << mint << "," << maxt << "), "
              << "hlen=" << round(l) << ", " << x << " = " << bandwidth
              << std::endl;
    return 1;
}
...
double pick_test(size_t id, size_t n, size_t rounds, bool half_length) {
    ...
    case 10:
        return run_multiple(n, rounds, 1, "random shuffle long",
                            t_shuffle<long>, half_length, "Gelts/sec");
    case 11:
    ...
    case 14:
        return run_multiple(n, rounds, 1, "integer sort<uint,uint>",
                            t_integer_sort_pair<uint>, half_length,
                            "Gelts/sec");
    case 15:
    ...
    case 17:
        return run_multiple(n, rounds, 1, "sort long", t_sort<long>,
                            half_length, "Gelts/sec");
    case 18:
        return run_multiple(n, rounds, 1, "sort uint", t_sort<uint>,
                            half_length, "Gelts/sec");
    case 19:
        return run_multiple(n, rounds, 1, "sort 128 bits", t_sort<__int128>,
                            half_length, "Gelts/sec");
    case 20:
        return run_multiple(n, rounds, ebytes(16, 8), "merge long",
                            t_merge<long>, half_length);
    case 21:
    ...
    case 30:
        return run_multiple(n, rounds, 1, "remove duplicates",
                            t_remove_duplicates<long>, half_length,
                            "Gelts/sec");
    case 31:
