...
pbbs::sequence<edge> compose_algorithm_and_sampling(Graph &G, commandLine &P,
                                                    Algorithm &alg) {
...
pbbs::sequence<edge> run_uf_alg(Graph &G, commandLine &P) {
    size_t n = G.n;
    auto find = get_find_function<find_option>();
    auto unite = get_unite_function<unite_option, decltype(find)>(n, find);
    using UF =
        union_find_sf::UFAlgorithm<decltype(find), decltype(unite), Graph>;
...
pbbs::sequence<edge> run_jayanti_alg(Graph &G, commandLine &P) {
    size_t n = G.n;
...
pbbs::sequence<edge> run_sample_only_alg(Graph &G, commandLine &P) {
...
pbbs::sequence<edge> run_liu_tarjan_alg(Graph &G, commandLine &P) {
