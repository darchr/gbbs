...
auto fetch_intercluster_small(Graph &GA, C &clusters, size_t num_clusters,
    ...
    auto edge_table = pbbslib::sparse_table<K, V, hash_pair>(
        small_cluster_size, empty, hash_pair());
...
auto fetch_intercluster_te(Graph &GA, C &clusters, size_t num_clusters,
    ...
    auto edge_table =
        pbbslib::sparse_table<K, V, hash_pair>(deg_map[n], empty, hash_pair());
...
auto fetch_intercluster(Graph &GA, C &clusters, size_t num_clusters,
    ...
    auto edge_table = pbbslib::sparse_table<K, V, hash_pair>(
        estimated_edges, empty, hash_pair());
    debug(std::cout << "sizeof table = " << edge_table.m << std::endl;);
...
inline auto contract(Graph &GA, sequence<uintE> &clusters, size_t num_clusters,
    ...
    auto sym_edges = sequence<std::tuple<uintE, uintE, pbbs::empty>>(
    ...
    auto ret_table = pbbslib::sparse_table<K, V, hash_pair>(
        table.m, table.empty, hash_pair());
