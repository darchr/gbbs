...
Clustering Cluster(symmetric_graph<VertexTemplate, pbbslib::empty> *graph,
    ...
    const pbbs::sequence<bool> core_bitmap(num_vertices, [&](const size_t i) {
    ...
    // Cluster all the cores by running BFS on the more-than-epsilon-similar
    // edges of the core vertices.
