...
TEST(ScanSubroutines, BasicUsage) {
...

    {
        ...
        EXPECT_THAT(core_order[2].slice(0, 2),
                    UnorderedElementsAre(CoreThresholdEq(2, 4.0 / sqrt(20)),
                                         CoreThresholdEq(3, 4.0 / sqrt(20))));
        EXPECT_THAT(core_order[2].slice(2, core_order[2].size()),
        ...
        EXPECT_THAT(core_order[3].slice(1, 3),
                    UnorderedElementsAre(CoreThresholdEq(2, 3.0 / sqrt(15)),
                                         CoreThresholdEq(4, 3.0 / sqrt(15))));
        EXPECT_THAT(core_order[3].slice(3, core_order[3].size()),
        ...
        EXPECT_THAT(core_order[4].slice(1, core_order[4].size()),
                    UnorderedElementsAre(CoreThresholdEq(1, 3.0 / sqrt(20)),
                                         CoreThresholdEq(2, 3.0 / sqrt(20))));
        EXPECT_THAT(core_order[5],
                    ElementsAre(CoreThresholdEq(2, 2.0 / sqrt(10))));
    }

    {
        const ii::CoreOrder core_order{neighbor_order};
        {
            ...
            const pbbs::sequence<uintE> cores{
                core_order.GetCores(kMu, kEpsilon)};
