...
std::vector<double> repeat(Graph &G, size_t rounds,
                           pbbs::sequence<parent> &correct, F test,
                           commandLine &P) {
    std::vector<double> R;
...
void print_cpu_stats(std::string &name, size_t rounds, double medt, double mint,
                     double maxt, CPUStats &stats, commandLine &P) {
    std::cout << "{" << std::endl;
...
void run_tests(Graph &G, int rounds, commandLine &P,
               pbbs::sequence<parent> &correct, F test_type,
