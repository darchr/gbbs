...
std::string uf_options_to_string(const SamplingOption sampling_option,
    ...
    return "uf; sample=" + sampling_to_string(sampling_option) +
...
std::string jayanti_options_to_string(const SamplingOption sampling_option,
    ...
    return "jayanti; sample=" + sampling_to_string(sampling_option) +
           "; find=" + jayanti_find_to_string(find_option);
}

std::string
liu_tarjan_options_to_string(const SamplingOption sampling_option,
