...
annotate_updates_insert(pbbs::sequence<std::tuple<uintE, uintE>> &updates,
                        size_t n) {
    auto seq = pbbslib::make_sequence<std::tuple<uintE, uintE, UpdateType>>(
        n, [&](size_t i) {
            auto &ith = updates[i];
...
pbbs::sequence<std::tuple<uintE, uintE, UpdateType>>
annotate_updates(pbbs::sequence<std::tuple<uintE, uintE>> &updates,
                 double insert_to_query, size_t n, bool permute) {
    ...
    auto result =
        pbbs::sequence<std::tuple<uintE, uintE, UpdateType>>(result_size);
